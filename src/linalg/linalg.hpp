...
void compute_sparse_Ax_y(const std::size_t & n, double * acsr, int * icsr, int * jcsr, double * x, double * y);
...
void compute_u_v_from_wxx(const std::size_t & number, const std::size_t & k,const std::size_t & i, const std::size_t & j, const std::size_t & nx, 
...
void compute_u_v_from_wxy(const std::size_t & number, const std::size_t & k, const std::size_t & i, const std::size_t & j, const std::size_t & nx, const double & skd,
				  const std::vector<std::vector<int>> & ip,
				  const std::vector<std::vector<int>> & iboundary,
				  const std::vector<std::vector<double>> & d,
				  const std::vector<std::vector<std::vector<double>>> & crystal,
...
void sort_and_add_matrix_elements(const std::size_t & nrow, const std::size_t & k, std::vector<int> & jcol, std::vector<double> & acol, 
